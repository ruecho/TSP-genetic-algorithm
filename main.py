...
# parameters
numbers_of_generations = 200  # iteration size
population_size = 100  # individual amount / this shows how many solutions will be available in a generation
mut_rate = 0.2  # mutation rate 
dataset = Ch.dataset  # locations info in a list form. each element of the list is a node object, which as id, x, y 
